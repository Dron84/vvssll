...
(function(factory) {
    ...
    return function() {
        ...
        // - It has a flag in the region-flag project: https://github.com/behdad/region-flags/tree/gh-pages/png
                ...
                value: function _initRequests() {
                    ...
                    if (this.options.utilsScript && !window.intlTelInputUtils) {
                        ...
                        if (window.intlTelInputGlobals.windowLoaded) {
                            ...
                            // wait until the load event so we don't block any other requests e.g. the flag image
                            window.addEventListener("load", function() {
